...
class HyperBrowserTool( DataSourceTool ):
    ...
    def exec_before_job( self, app, inp_data, out_data, param_dict):
        ...
        DataSourceTool.exec_before_job(self, app, inp_data, out_data, param_dict)
...
tool_types = {}
for tool_class in [ Tool, DataDestinationTool, SetMetadataTool, DataSourceTool, AsyncDataSourceTool, HyperBrowserTool, HyperBrowserGenericTool]:
