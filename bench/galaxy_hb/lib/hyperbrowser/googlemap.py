...
from quick.util.CommonFunctions import extractIdFromGalaxyFn, getUniqueWebPath, getRelativeUrlFromWebPath
from config.Config import *
import quick.aux.GoogleMapsInterface as GoogleMapsInterface
...
class GoogleMapController(BaseToolController):
    ...
    def execute(self, imageFn, html, dpi = None):
        ...
        f.write('''
                ...
                ''' % (getRelativeUrlFromWebPath(outDir) + '/index.html', info[1], info[2]))
        f.close()
        #print out, err
