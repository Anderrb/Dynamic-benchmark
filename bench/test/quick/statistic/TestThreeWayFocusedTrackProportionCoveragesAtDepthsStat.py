...
from quick.statistic.ThreeWayFocusedTrackProportionCoveragesAtDepthsStat import ThreeWayFocusedTrackProportionCoveragesAtDepthsStat

class TestThreeWayFocusedTrackProportionCoveragesAtDepthsStatUnsplittable(StatUnitTest):
    classToCreate = ThreeWayFocusedTrackProportionCoveragesAtDepthsStat
