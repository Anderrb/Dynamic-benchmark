...
from quick.statistic.ThreeWayExpectedBpOverlapGivenBinPresenceStat import ThreeWayExpectedBpOverlapGivenBinPresenceStat

class TestThreeWayExpectedBpOverlapGivenBinPresenceStatUnsplittable(StatUnitTest):
    classToCreate = ThreeWayExpectedBpOverlapGivenBinPresenceStat
