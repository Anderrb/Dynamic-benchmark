...
class TestMeanOfCoveredBpsInSegmentsStatUnsplittable(StatUnitTest):
    classToCreate = MeanOfCoveredBpsInSegmentsStat
    
    def test_compute(self):
        self._assertCompute(2, SampleTV_Num( vals=[2]*90, anchor=[10,100] ), SampleTV( segments=[[0,10]], anchor=[10,100] ))
        self._assertCompute(4, SampleTV( segments=[[10,20], [80,85]], vals=[1,10], anchor=[10,100] ), SampleTV( segments=[[10,20], [80,85]], anchor=[10,100] ))
        self._assertCompute(10,  SampleTV( starts=[2,15,60], vals=[2,10,100], anchor=[10,100] ), SampleTV( segments=[[10,20], [80,90]], anchor=[10,100] ))
        self._assertCompute(8, SampleTV( ends=[15,90], vals=[2,10], anchor=[10,100] ), SampleTV( segments=[[10,20], [40,50]], anchor=[10,100] ))
