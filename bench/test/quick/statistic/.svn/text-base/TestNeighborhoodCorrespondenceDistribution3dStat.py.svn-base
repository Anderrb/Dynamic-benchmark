...
class TestNeighborhoodCorrespondenceDistribution3dStatUnsplittable(StatUnitTest):
    classToCreate = NeighborhoodCorrespondenceDistribution3dStat
    ...
    def test_compute(self):
        ...
        self._assertCompute(None, SampleTV( starts=[], ids=[], edges=[] ),globalSource='userbins')
        self._assertCompute([2.0,None], SampleTV( starts=[0,10,120,130], ids=['a','b','c','d'], edges=[['d'],['d'],['d'],list('abc')], anchor=[0,200] ), globalSource='userbins')
...
#    classToCreate = NumberOfNodesAndEdges3dStat
#
#    def test_compute(self):
#        pass
#        
