...
class TestFileFormatComposers(TestWithGeSourceData, TestCaseWithImprovedAsserts):
    ...
    def testValuedBedComposer(self):
        self._commonTestComposer(withTrackGESource=False, composerCls=ValuedBedComposer, suffix='marked.bed')
    
    def testMarkedBedFromTrackComposer(self):
        self._commonTestComposer(withTrackGESource=True, composerCls=ValuedBedComposer, suffix='marked.bed')
