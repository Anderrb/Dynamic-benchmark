...
class TestBoundingRegionShelve(unittest.TestCase):
    ...
    def _testGetBoundingInfoOutsideCommon(self, sparse):
        ...
        self.assertEquals(BoundingRegionInfo(50000, 1052000, 0, 0, 0, 0),
                          self._brShelve.getBoundingRegionInfo(GenomeRegion('TestGenome', 'chr21', 50000, 1052000)))
        self.assertEquals(BoundingRegionInfo(1000000, 1052000, 0, 0, 0, 0),
                          self._brShelve.getBoundingRegionInfo(GenomeRegion('TestGenome', 'chr21', 1000000, 1052000)))
        self.assertEquals(BoundingRegionInfo(1500, 3000, 0, 0, 0, 0),
                          self._brShelve.getBoundingRegionInfo(GenomeRegion('TestGenome', 'chrM', 1500, 3000)))
    ...
    def testStdGetTotalElementCountForChrSparse(self):
        ...
        self.assertEquals(30,
                          self._brShelve.getTotalElementCount('chr21'))
        self.assertEquals(5,
                          self._brShelve.getTotalElementCount('chrM'))
        self.assertEquals(0,
                          self._brShelve.getTotalElementCount('chr1'))
