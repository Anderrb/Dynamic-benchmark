...
from quick.util.CommonFunctions import ensurePathExists, getUniqueRunSpecificId, getLoadToGalaxyHistoryURL
...
class StaticFile(object):
    ...
    def getLoadToHistoryLink(self, linkText, galaxyDataType=None):        
...
class RunSpecificPickleFile(GalaxyRunSpecificFile):
