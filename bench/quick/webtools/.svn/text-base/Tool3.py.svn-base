...
class Tool3(GeneralGuiTool):
    ...
    def getInputBoxNames():
        ...
        return ['Enter question','Enter answer']
    ...
    def execute(choices, galaxyFn=None, username=''):
        myInfo = [choices[0], choices[1]]
        print galaxyFn
        pickleObj = RunSpecificPickleFile(galaxyFn)
        print pickleObj.getDiskPath()
        pickleObj.storePickledObject(myInfo)
