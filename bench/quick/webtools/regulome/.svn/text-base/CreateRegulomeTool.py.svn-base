...
dataset and the disease dataset created. Select normalization strategy and
click "Execute". You will be redirected to the "Perform analysis" tool, with
the regulome question preselected, along with some standard arguments. If you
want to change the clustering strategy, or other parameters, please do so.
Then click the "Start analysis" button.
</ol>
