...
class NmerExtractTool(GeneralGuiTool):
    @staticmethod
    def getToolName():
        return "Extract nmer occurrence track"
    ...
    def getToolDescription():
        ...
        core = HtmlCore()
        core.paragraph('Extract occurrences of a given nmer in a specified region along the selected genome. Nmer occurrence track is extracted as a bed-file.')
        core.divider()
        core.highlight('Nmer')
