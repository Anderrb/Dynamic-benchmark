...
class NmerAnalyzeTool(GeneralGuiTool):
    ...
    def getToolDescription():
        ...
        core = HtmlCore()
        core.paragraph('Analyze occurrences of a given nmer along the genome, either in itself or in relation to other genomic tracks.')
        core.divider()
        core.paragraph('First, select a genome and nmer of interest. Then a full analysis specification page appears, where one can directly start a basic analysis or specify further details on the analysis of interest.')
        core.divider()
        core.highlight('Nmer')
