...
from config.Config import DebugConfig, DATA_FILES_PATH
import third_party.safeshelve as safeshelve
from os import sep
#This is a template prototyping GUI that comes together with a corresponding web page.
#

class DebugAnalysisTool(UserBinSelector):
    _extraParams = []
    ...
    #    return ['testChoice1','..']
    @classmethod    
    def setupDebugModeAndLogging(cls,verbose):
        from gold.application.LogSetup import defaultFormatter, HB_LOGGER
        import logging
        import sys
        detailedHandler = logging.StreamHandler(sys.stdout)
        ...
        DebugConfig.PASS_ON_BATCH_EXCEPTIONS = True
