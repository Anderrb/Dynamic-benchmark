...
class McFdrSimulationTool(GeneralGuiTool):
    @staticmethod
    def getToolName():
        return "MC-FDR simulation (experimentation purposes)"
...
#totalNumTests, stepSize, numReplications,a,b, h, maxNumSamples, fdrThreshold
    ...
    def execute(choices, galaxyFn=None, username=''):
        ...
        print 'Corresponding batch run line:<br>', '$Tool[mc_fdr_simulation_tool](%s)' % '|'.join(choices)
        ...
        from test.sandbox.aux.McFdr import Experiment, MultipleTestCollection, Simulator
