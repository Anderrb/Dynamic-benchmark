from quick.webtools.MultiTrackSelector import MultiTrackSelector
...
class AnalyzeMultiTrackRelations(MultiTrackSelector, UserBinSelector):
    @staticmethod
    def getToolName():
        '''
    ...
    def getInputBoxNames():
        ...
        '''
        return MultiTrackSelector.getMultiTrackInputBoxNames()+[('Select analysis','Analysis'), ('Lower-order relations to preserve in null model','PreserveRelations'), ('Track properties to preserve in null model','PreserveProperties'), ('Number of MC samples','NumResamplings')] + UserBinSelector.getUserBinInputBoxNames()
