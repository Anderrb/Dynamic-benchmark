...
class UserBinSelector(GeneralGuiTool):
    ...
    def getOptionsBoxCompareIn(prevChoices): # Alternatively: getOptionsBoxKey()
        ...
        '''
        return ['Chromosome arms','Chromosomes','Cytobands','Genes(Ensembl)','ENCODE Pilot regions','Custom specification','Bins from history']
    ...
    def getOptionsBoxBins(prevChoices): 
        ...
        '''
        if prevChoices.CompareIn in ['Chromosome arms','Chromosomes','Cytobands','Genes(Ensembl)','ENCODE Pilot regions']:
            return ''
    ...
    @staticmethod    
    def getOptionsBoxHistoryBins(prevChoices): 
        '''
        See getOptionsBoxCompareIn().
        '''
