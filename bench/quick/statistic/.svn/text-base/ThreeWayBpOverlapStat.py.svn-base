...
class ThreeWayBpOverlapStat(MagicStatFactory):
    ...
    Note that coverage by subsets is not disjunct, so that e.g. result for '01', denoting coverage by track2 (for two track overlap) also includes bps covered by both tracks
    '''
    pass
