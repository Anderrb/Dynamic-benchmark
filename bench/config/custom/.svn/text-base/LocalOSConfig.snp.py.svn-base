HB_SOURCE_CODE_BASE_DIR = '/usit/invitro/data/hyperbrowser/hb_core_snp'
GALAXY_BASE_DIR = '/usit/invitro/data/galaxy/galaxy_snp'

IS_EXPERIMENTAL_INSTALLATION = True

RESTRICTED_USERS = 'sveinugu@gmail.com, k.h.ring@sum.uio.no'
...
HEADER_TITLE = 'The Genomic HyperBrowser (SNP version)'
HEADER_SMALL_LOGO_IMAGE = 'HB_logo_title_small.png'

WELCOME_NOTICE_HTML = '<div class="noticebox"><b>Notice</b> <p><i>This is an unstable version of The Genomic HyperBrowser for a master project on SNPs and is not suited for public use. If you are a user, you should instead use the stable <a href="http://hyperbrowser.uio.no" target="main">main version of the HyperBrowser</a>. The user and history database is not the same between the different versions.</i></p></div>'
...
EXT_LOG_PATH = '/usit/invitro/work/hyperbrowser/nosync/logs/snp'
EXT_RESULTS_PATH = '/usit/invitro/hyperbrowser/results/snp'
...
GALAXY_JOB_RUNNER_PORT = '59140'
GALAXY_JOB_RUNNER_THREADPOOL_WORKERS = '5'
GALAXY_WEB_SERVER_PORT = '58140'
GALAXY_WEB_SERVER_THREADPOOL_WORKERS = '10'
GALAXY_ADDITIONAL_WEB_SERVER_COUNT = '1'
GALAXY_TRANSFER_MANAGER_PORT = '57140'
GALAXY_LOCAL_JOB_QUEUE_WORKERS = '8'

GALAXY_DATABASE_CONNECTION = 'mysql://galaxy_snp:yxalag2@localhost/galaxy_snp?unix_socket=/var/lib/mysql/mysql.sock'
...
GALAXY_DEBUG = True
GALAXY_ID_SECRET = 'sd*9ec,vmewo&znudjalsdkfj454sDDDFS#&&DDdaq'
GALAXY_ADMIN_USERS = 'sveinugu@gmail.com,k.h.ring@sum.uio.no'
...
PP_PASSPHRASE = "D&,197Ddjg.q,pcgtsyhDYThh5"
PP_PORT=56140
PP_MANAGER_PORT=55140
