HB_SOURCE_CODE_BASE_DIR = '/usit/invitro/data/hyperbrowser/hb_core_mcfdr'
GALAXY_BASE_DIR = '/usit/invitro/data/galaxy/galaxy_mcfdr'

IS_EXPERIMENTAL_INSTALLATION = False

RESTRICTED_USERS = 'geirkjetil@gmail.com, morj@rr-research.no, ehovig@ifi.uio.no, morj@medisin.uio.no, halfdan.rydbeck@rr-research.no, sveinugu@gmail.com, hrydbeck@gmail.com, Marit.Holden@nr.no, vegardny@radium.uio.no, trevor.clancy@rr-research.no, stale.nygard@medisin.uio.no, jonaspau@ifi.uio.no, trengere@gmail.com, sigve.nakken@medisin.uio.no'
...
HEADER_TITLE = 'The Genomic HyperBrowser (MCFDR version)'
HEADER_SMALL_LOGO_IMAGE = 'HB_logo_title_small.png'

WELCOME_NOTICE_HTML = '<b>Notice</b> <p><i>This is the MCFDR version of The Genomic Hyperbrowser, implementing the MCFDR algorithm, as described in a <a href="http://bioinformatics.oxfordjournals.org/content/early/2011/10/13/bioinformatics.btr568.abstract">recent paper in Bioinformatics</a>. The user and history database is not the same as the one used in the stable version (hyperbrowser.uio.no/hb).</i></p>'
WELCOME_LOGO_IMAGE = 'HB_logo.png'
WELCOME_TITLE_IMAGE = 'HB_title.png'

GALAXY_HTML_META_TAGS = ''
GOOGLE_ANALYTICS_WEB_PROPERTY_ID = 'UA-26260062-1'
...
EXT_LOG_PATH = '/usit/invitro/work/hyperbrowser/nosync/logs/mcfdr'
EXT_RESULTS_PATH = '/usit/invitro/hyperbrowser/results/mcfdr'
...
GALAXY_JOB_RUNNER_PORT = '59000'
GALAXY_JOB_RUNNER_THREADPOOL_WORKERS = '5'
GALAXY_WEB_SERVER_PORT = '58000'
GALAXY_WEB_SERVER_THREADPOOL_WORKERS = '10'
GALAXY_ADDITIONAL_WEB_SERVER_COUNT = '1'
GALAXY_TRANSFER_MANAGER_PORT = '57000'
GALAXY_LOCAL_JOB_QUEUE_WORKERS = '4'

GALAXY_DATABASE_CONNECTION = 'mysql://galaxy_mcfdr:yxalag2@localhost/galaxy_mcfdr?unix_socket=/var/lib/mysql/mysql.sock'
...
GALAXY_DEBUG = True
GALAXY_ID_SECRET = '867dtf7h376c8w7rb76ti76t7HJkK'
...
PP_PASSPHRASE = "HHdhjs6&djd24"
PP_PORT=56000
PP_MANAGER_PORT=55000
#
# Debug code
#
