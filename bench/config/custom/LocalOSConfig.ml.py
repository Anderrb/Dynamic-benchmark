HB_SOURCE_CODE_BASE_DIR = '/usit/invitro/data/hyperbrowser/hb_core_ml'
GALAXY_BASE_DIR = '/usit/invitro/data/galaxy/galaxy_ml'

IS_EXPERIMENTAL_INSTALLATION = True

RESTRICTED_USERS = 'geirkjetil@gmail.com, morj@rr-research.no, ehovig@ifi.uio.no, morj@medisin.uio.no, sveinugu@gmail.com, fredrik@nbmedia.no, trengere@gmail.com'
...
HEADER_TITLE = 'The Genomic HyperBrowser (machine learning version)'
HEADER_SMALL_LOGO_IMAGE = 'HB_logo_title_small.png'

WELCOME_NOTICE_HTML = '<div class="noticebox"><b>Notice</b> <p><i>This is an unstable version of The Genomic HyperBrowser for a master project on machine learning and is not suited for public use. If you are a user, you should instead use the stable <a href="http://hyperbrowser.uio.no" target="main">main version of the HyperBrowser</a>. The user and history database is not the same between the different versions.</i></p></div>'
...
EXT_LOG_PATH = '/usit/invitro/work/hyperbrowser/nosync/logs/ml'
EXT_RESULTS_PATH = '/usit/invitro/hyperbrowser/results/ml'
...
GALAXY_DATABASE_CONNECTION = 'mysql://galaxy_ml:yxalag2@localhost/galaxy_ml?unix_socket=/var/lib/mysql/mysql.sock'
...
GALAXY_DEBUG = True
GALAXY_ID_SECRET = 'asd678dsfhJJhHJhJGkjhdgfkj345578'
GALAXY_ADMIN_USERS = 'morj@rr-research.no,sveinugu@gmail.com,geirkjetil@gmail.com,fredrik@nbmedia.no'
...
PP_PASSPHRASE = "GHJhjk52#j2"
PP_PORT=56010
PP_MANAGER_PORT=55010
#
# Debug code
#
