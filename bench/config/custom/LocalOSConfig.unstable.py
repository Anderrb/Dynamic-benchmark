HB_SOURCE_CODE_BASE_DIR = '/usit/invitro/data/hyperbrowser/hb_core_unstable'
GALAXY_BASE_DIR = '/usit/invitro/data/galaxy/galaxy_unstable'

IS_EXPERIMENTAL_INSTALLATION = True

RESTRICTED_USERS = 'morj@rr-research.no, morj@medisin.uio.no, sveinugu@gmail.com'
...
EXT_LOG_PATH = '/usit/invitro/work/hyperbrowser/nosync/logs/unstable'
EXT_RESULTS_PATH = '/usit/invitro/hyperbrowser/results/unstable'
...
GALAXY_JOB_RUNNER_PORT = '59150'
GALAXY_JOB_RUNNER_THREADPOOL_WORKERS = '5'
GALAXY_WEB_SERVER_PORT = '58150'
GALAXY_WEB_SERVER_THREADPOOL_WORKERS = '10'
GALAXY_ADDITIONAL_WEB_SERVER_COUNT = '1'
GALAXY_TRANSFER_MANAGER_PORT = '57150'
GALAXY_LOCAL_JOB_QUEUE_WORKERS = '8'

GALAXY_DATABASE_CONNECTION = 'mysql://galaxy_unstable:yxalag2@localhost/galaxy_unstable?unix_socket=/var/lib/mysql/mysql.sock'
...
GALAXY_DEBUG = True
GALAXY_ID_SECRET = 'd&%qe4k89d.dlskvmp!ytnbyhjDFnL'
GALAXY_ADMIN_USERS = 'morj@rr-research.no,sveinugu@gmail.com,harad@ifi.uio.no'
...
PP_PASSPHRASE = "Dk89DW^tsb68!!d"
PP_PORT=56150
PP_MANAGER_PORT=55150
